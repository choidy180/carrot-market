       ...
       <div className="mt-8">
           ...
           <div className="grid border-b w-full mt-8 grid-cols-2">
             <button 
              className={cls(
                ...
                method === "email" ? "border-orange-400 text-orange-400" : " border-transparent text-gray-500"
              )}
              onClick={onEmailClick}>Email address</button>
             <button 
              className={cls(
                "pb-4 font-medium border-b-2",
                method === "phone" ? "border-orange-400 text-orange-400" : "border-transparent text-gray-500"
              )}
              onClick={onPhoneClick}>Phone</button>
           </div>
         </div>
         <form className="fle flex-col mt-8">
         ...
         <div className="mt-8">
           ...
           <div className="grid grid-cols-2 mt-6 gap-3">
            <button className="
              flex justify-center items-center py-2 px-4 border border-gray-300
