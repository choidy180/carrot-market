...
const CommunityPostDetail: NextPage = () => {
  return (
    <Layout title="동네질문 답변" hasTabBar>
      <div>
        <span 
          className="
            inline-flex my-2.5 ml-4 mb-1 items-center px-2.5 py-0.5
        ...
        <div>
          ...
          <div className="flex pr-4 space-x-5 mt-3 pl-4 text-gray-700 py-2.5 border-t border-b-[2px] w-full">
